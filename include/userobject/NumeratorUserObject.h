...
#ifndef NUMERATORUSEROBJECT_H
#define NUMERATORUSEROBJECT_H
...
class NumeratorUserObject;

template <>
InputParameters validParams<NumeratorUserObject>();
...
class NumeratorUserObject : public UserObject,
...
{
public:
  NumeratorUserObject(const InputParameters & parameters);
